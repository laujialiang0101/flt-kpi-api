...
# ============================================================================
# Admin Data Exploration (for WMS planning)
# ============================================================================
...
@app.get("/api/v1/admin/inventory-overview")
async def get_inventory_overview(
    api_key: str = Query(..., description="API key for authentication")
):
    """Get overview of inventory-related tables for WMS planning."""
    expected_key = os.getenv('PUSH_API_KEY', 'flt-push-2024')
    if api_key != expected_key:
        raise HTTPException(status_code=401, detail="Invalid API key")
    ...
    try:
        async with pool.acquire() as conn:
            ...
            for t in inv_tables:
                ...
                result["inventory_tables"].append({
                    "table": tbl,
                    "columns": col_count,
